...
public class GestorDeposito {
	public static void main(String[] args){
		...
		System.out.println("Introduce datos para el depósito estructurado");
		System.out.println("Introduce nombre y apellidos del titular");
		titular =Leer.dato();
		...
		// **** Puedo utilizar la interface Amortizable como tipo.
		...
		Amortizable deposito2 = new DepositoEstructurado(titular, capital, 
				plazoDias, tipoInteres, tipoInteresAmpliado, capitalAmpliado);
		...
		//*** Realizo amortización del deposito
		deposito2.amortizar(100);
		
		// *** Hago casting a tipo DepositoEstructurado para usar su método liquidar.
		System.out.println("El resultado del depósito estructurado es: " + ((DepositoEstructurado) deposito2).liquidar());
	}
