...
public class ElectrodomesticosApp {
	...
	public static void main(String[] args) {
        ...
        int numElectrodomesticos, numTelevisores, numLavadoras;
        numElectrodomesticos = numLavadoras = numTelevisores = 0;
        ...
        System.out.println("Num. televisores: " + numTelevisores);
